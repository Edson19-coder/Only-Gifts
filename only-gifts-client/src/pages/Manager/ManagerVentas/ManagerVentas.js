...
import { getPurchaseDetail, getPurchasesManager, getPurchasesManagerHistory, updatePurchase } from '../../../api/PurchaseAPI';
...
const ManagerVentas = () => {
    ...
    useEffect(() => {
        getPurchasesManagerHistory(token).then(result => {
            var purchases = [];
            if (result) {
